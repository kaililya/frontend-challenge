...
function CatsCard({post, handelClick}:any) {
  ...
  return (
    <li 
      className={styles.image_wapper} 
      // onClick={handelHeartClick}
      >
      <img className={styles.image} src={post.url} alt="" />
      <div onClick={handelHeartClick} className={post.isLicked ? `${styles.heart_icon} ${styles.heart_icon__clicked}` : `${styles.heart_icon}`}>
      {post.isLicked ? (
        <svg       
      ...
      {/* <HeartIcon hasBackground={isClicked} /> */}
    </li>
  );
}
